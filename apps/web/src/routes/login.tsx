...
function Login() {
  ...
  return (
    <div className="app-shell relative flex min-h-screen flex-col items-center justify-center overflow-hidden px-4 py-10">
      ...
      <div className="login-card-enter login-icon-float login-card card relative z-10 w-full max-w-md p-7 text-center sm:p-9">
        ...
        <h1 className="mb-2 text-3xl font-bold text-white">{t('app.name')}</h1>
        <p className="mb-6 text-sm font-medium text-white/70">{t('login.tagline')}</p>

        {error && (
          <div className="mb-4 rounded-2xl border border-red-500/15 bg-red-500/10 p-3 text-sm font-semibold text-brand-600">
            {errorMessages[error] ?? t('login.error.generic')}
          </div>
        )}

        <a
          href="/auth/slack"
          className="btn-primary flex w-full items-center justify-center gap-2 transition-all duration-200 hover:-translate-y-0.5 hover:shadow-xl hover:shadow-red-500/30"
        >
          ...
          {t('login.signInWithSlack')}
        </a>

        <div className="mt-6 flex items-center justify-center gap-5">
          <a
            href="https://github.com/SeanChangX/packman"
            target="_blank"
